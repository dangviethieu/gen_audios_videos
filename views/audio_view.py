            ...
            [
                sg.Frame('Setting', [
                    [
                        ...
                        sg.Text('No output files'), sg.In(self.config_setup.config_audios.files_output_number, key='audio_files_output_number', size=(3,1)),
                        sg.Text('No input files'), sg.In(self.config_setup.config_audios.files_input_number, key='audio_files_input_number', size=(3,1)), 
        ...
        if event == 'start_concat_audios':
            ...
            self.config_setup.store_audio_sub_config(
                Config(
                    ...
                    files_output_number=self.window['audio_files_output_number'].get(),
                    files_input_number=self.window['audio_files_input_number'].get(),
